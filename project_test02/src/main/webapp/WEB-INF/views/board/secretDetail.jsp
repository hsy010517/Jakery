		...
		<div class="boardDetail-content">
			...
			<ul class="boardDetail-content-item boardDetail-content-title">
				<li class="boardcontent-title-item boardcontent-title">
					${secretboard.secrettitle}</li>
				<li>
					<div class="secretDetail-btn-div">
						<sec:authorize access="hasRole('ROLE_USER')">
							<c:if test="${secretboard.users.userid==principal.user.userid}">
								<a href="/secretboard/${secretboard.secretnum}/secretUpdateForm"
									class="secretboardbtn secretboardbtn-update"><i
									class="fa-solid fa-pencil"></i></a>
								<button id="secretboardbtn-delete"
									class="secretboardbtn secretboardbtn-delete">
			...
			<ul class="boardDetail-content-item secretboardDetail-info">
				<li class="boardcontent-title-item boardcontent-num info_group">
					<span class="info_detail">NUM : </span><span id="num"
					class="info_detail_content"> ${secretboard.secretnum} </span>
				</li>
				<li class="boardcontent-title-item boardcontent-username info_group">
					<span class="info_detail">WRITER : </span><span
					class="info_detail_content"> ${secretboard.users.username} </span>
				</li>
				<li class="boardcontent-title-item boardcontent-username info_group">
					<span class="info_detail">작성일 : </span><span
					class="info_detail_content"> <fmt:formatDate value="${secretboard.createDate}" pattern="yyyy-MM-dd"/> </span>
				</li>
				<li class="boardcontent-title-item boardcontent-count info_group">
					<span class="info_detail">답변 : </span> <span id="count"
					class="info_detail_content"> <c:choose>
		...
		<div class="freereply-content">
			...
			<div class="freereply-form-div">
				...
				<form class="freereply-form">
					<input type="hidden" id="secretnum"
						value="${secretboard.secretnum}" />
					<div class="freereply-username" style="color: #999;">
						작성자: <input style="color: #999;" type="text" id="secretreplyuser"
							value="${principal.user.username}" disabled />
					</div>
					<div class="freereply-comment dummy">
						<textarea id=secretreplycontent class="reply-form-note" rows="5"
							cols="130" placeholder="댓글을 입력하세요."></textarea>
						<button id="secretboardreplybtn-save" class="freeboard-reply-btn"
			...
			<div class="freereply-contents-div">
				<div class="freereply-contents-header">
					<a href="javascript:doDisplay()">댓글 목록
						(${secretboard.secretreplycnt}) <i id="chevron-down"
