						...
						<div class="cart">
							<div class="cart__information">
								<ul class="cart-info-ul">
									<li class="cart-info-li-first cart-info-li">장바구니 상품은 <b>최대
											30일간 저장</b>됩니다.
									</li>
									<li class="cart-info-li">가격, 옵션 등 정보가 변경된 경우 주문이 불가할 수
										있습니다.</li>
									<li class="cart-info-li">주문시 픽업(예약)과 배송(택배) 여부를 반드시
										확인해주세요. <b>선택 실수로 인한 환불 및 변경은 불가</b>합니다.
									</li>
								</ul>
							</div>
							<a class="mypage-cart-logo" href="/"><span
								style="color: #ffc730;">C</span><span style="color: #303030;">ART</span></a>
							<table class="cart__list">
								<form>
									<thead class="cart__list_thead">
										<tr class="cart__list_thead_tr">
											<th style="width: 5%;" class="cart__list_th dummy"><input
									...
									<tbody class="cart__list__tbody">
										<tr class="cart__list__detail">
											...
											<td class="cart-main"><img class="cart-img" src="">
												<div class="cart-title">
													<span class="cart-sub">1줄 설명</span>
													<p class="cart-name">상품명상품명</p>
													<sapn class="cart-price">
													<span id="mypage-price">1000</span>원</sapn>
												</div></td>
											<td>
												<div class="cart__list__option">
													<form name="product_count" action="">
														<p class="cart-option-num">
															상품명 / <span id="mypage-count-result">1</span> 개
														</p>
											...
											<td><span class="cart-price"><span
													id="mypage-price-result">1000</span>원</span><br>
												<button class="cart__list__orderbtn">바로 주문하기</button></td>
										</tr>
										<tr class="cart__list__detail">
											<td>
												<div>
