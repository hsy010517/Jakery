	...
	<div class="buylist">
		<div class="buylist__information">
			<ul class="buylist-info-ul">
				<li class="buylist-info-li-first buylist-info-li">해당 페이지의 상품은
					이미 주문이 완료된 제품들입니다.</li>
				<li class="buylist-info-li">제품 특성상 <b>제작이 시작된 제품은 환불 및 변경이
						불가</b> 합니다.
				</li>
				<li class="buylist-info-li">픽업(예약)과 배송(택배) <b>선택 실수로 인한 환불
						및 변경은 불가</b>합니다.
				</li>
				<li class="buylist-info-li">자세한 문의는 1:1 게시판 또는 SNS를 통해 부탁드립니다.</li>
			</ul>
		</div>
		<a class="mypage-buylist-logo" href="/"><span
			style="color: #ffc730;">B</span>UY &nbsp;<span
			style="color: #303030;"><span style="color: #ffc730;">
					L</span>IST<span style="color: #303030;"></a>
			...
			<form>
				<thead>
					<tr>
						...
						<th style="width: 12%;" class="buylist__list_th dummy">예약 및 <br>배송
							정보
						</th>
				...
				<tbody>
					...
					<tr class="buylist__list__detail">
						<td class="buylist-main"><img class="buylist-img" src="">
						...
						<td><span class="buylist-price2">116,620원</span><br></td>
						<td><span class="buylist-pay">완료</span><br></td>
						<td><span class="buylist-op">예약/택배</span><br>
							<button class="buylist__list__orderbtn">확인하기</button></td>
					</tr>
					<tr class="buylist__list__detail">
						<td class="buylist-main"><img class="buylist-img" src="">
							<div class="buylist-title">
