    ...
    <form action="/action_page.php" onsubmit="return false" class="mypage-register-form">
      <div class="mypage-register-div">
        ...
        <div class="mypage-registerform-input">
          ...
          <input type="password" class="mypage-registerform-control" id="password" autofocus>
          ...
          <input type="text" class="mypage-registerform-control" name="address" value="입력된 주소" placeholder="Enter Your Address" id="address" >
