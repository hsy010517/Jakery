      ...
      <div class="notice-content">
          ...
          <li>
            <div class="freeDetail-btn-div">
              <sec:authorize access="hasAnyRole('ROLE_ADMIN')">
               <a href="/notice/${notice.noticenum}/updateForm" class="freeboardbtn freeboardbtn-update"><i class="fa-solid fa-pencil"></i></a>
                  <button id="noticebtn-delete" class="freeboardbtn freeboardbtn-delete"><i class="fa-solid fa-trash"></i></button>
              </sec:authorize> 
            </div>
          </li>
        </ul>
        <ul class="notice-content-item notice-info">
          <li class="boardcontent-title-item boardcontent-num info_group">
            <span class="info_detail">NUM : </span><span id="noticenum" class="info_detail_content">
                ${notice.noticenum}
              </span>
          </li>
