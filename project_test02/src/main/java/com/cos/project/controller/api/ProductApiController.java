...
public class ProductApiController {
	...
	public ResponseDto<Integer> save(@RequestPart(value = "key") ProductsSaveRequestDto requestDto,
	...
	@DeleteMapping("/api/product/{pronum}")
	public ResponseDto<Integer> deleteByPronum(@PathVariable int pronum) {
		productService.상품삭제(pronum);
		return new ResponseDto<Integer>(HttpStatus.OK.value(), 1);
	}
